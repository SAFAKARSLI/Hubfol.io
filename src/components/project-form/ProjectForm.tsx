      ...
      steps={[
        {
          ...
          fetchResource: '',
          callback: `${baseUrl}/u/${username}/projects/edit/${projectUUID}/sections?${searchParams.toString()}`,
        ...
        },
        {
          ...
          fetchResource: '',
          callback: `${baseUrl}/u/${username}/projects/edit/${projectUUID}/frame-options?${searchParams.toString()}`,
          slug: 'sections',
          index: 1,
        },
        {
          ...
          fetchResource: '',
          callback: `${baseUrl}/u/${username}/projects/edit/${projectUUID}/review?${searchParams.toString()}`,
          slug: 'frame-options',
          index: 2,
        },
        {
